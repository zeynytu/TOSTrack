...
class LaSOTDataset(BaseDataset):
    ...
    def _get_sequence_list(self):
        ...
        sequence_list = []
        attribute_number = 13
        print("attribute_number", attribute_number)
        ...
        for path in os.listdir("/home/zeyn/tracking/LaSOT_Evaluation_Toolkit/annos/att/"):
            contents = read_txt("/home/zeyn/tracking/LaSOT_Evaluation_Toolkit/annos/att/"+path)
            x = contents[0].split(",")
            if x[attribute_number] == "1":
                # print(path.replace(".txt", "")+",")
                att.append(path.replace(".txt", ""))

        test = read_txt("/home/zeyn/tracking/LaSOT_Evaluation_Toolkit/sequence_evaluation_config/testing_set.txt")
        # print(test)
        # for video in att:
        #     if video in test:
        #         sequence_list.append(video)
        sequence_list = [
                         'airplane-1',
                         'airplane-9',
                         'airplane-13',
