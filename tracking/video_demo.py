...
def main():
    ...
    parser.add_argument('--videofile', type=str,default="/video/basketball-11.mp4", help='path to a video file.')
    parser.add_argument('--optional_box', type=float, default=[621, 408, 35, 39], nargs="+", help='optional_box with format x y w h.')
    # parser.add_argument('--optional_box', type=float, default=[1196, 654, 74, 60], nargs="+", help='optional_box with format x y w h.')
